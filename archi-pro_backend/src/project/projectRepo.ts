...
export class ProjectRepository {
    ...
    getProjectUserId(projectId: string): string | undefined {
        const project = this.findById(projectId);
        return project?.user.id;
    }

    constructor(private readonly userRepository: UserRepository) {
        const defaultUser = this.userRepository.getAllUsers()[0];
        const project1 = new Project(defaultUser, "Housing Complex", ProjectCategory.RESIDENTIAL, "Building a new housing complex in the city center, consisting of 100 apartments and commercial spaces on the ground floor.", new Date("2024-01-01"), new Date("2025-12-31"));
        ...
        const project2 = new Project(defaultUser, "Office Building", ProjectCategory.URBAN, "Designing a modern office building with sustainable features and flexible workspaces for a tech company.", new Date("2024-02-01"), new Date("2025-11-30"));
        ...
        const project3 = new Project(defaultUser, "Community Center", ProjectCategory.MIXED_USE, "Creating a community center that includes a library, sports facilities, and event spaces to serve the local neighborhood.", new Date("2024-03-01"), new Date("2025-10-31"));
        ...
        const project4 = new Project(defaultUser, "City Park", ProjectCategory.LANDSCAPE, "Designing a new city park with walking trails, playgrounds, and green spaces to enhance urban livability.", new Date("2024-04-01"), new Date("2025-09-30"));
        project4.status = ProjectStatus.PLANNING;
        project4.progress = 5;
        project4.currentStage = ProjectStage.RESEARCH;
        project4.workingHours = 5;
        const project5 = new Project(defaultUser, "Museum of Modern Art", ProjectCategory.CULTURAL, "Creating a new museum of modern art that features innovative architecture and interactive exhibits.", new Date("2024-05-01"), new Date("2025-08-31"));
        ...
        const project6 = new Project(defaultUser, "Bridge Construction", ProjectCategory.INFRASTRUCTURE, "Constructing a new bridge to improve transportation connectivity between two major urban areas.", new Date("2024-06-01"), new Date("2025-07-31"));
        ...
        const project7 = new Project(defaultUser, "University Campus", ProjectCategory.EDUCATIONAL, "Designing a new university campus that includes academic buildings, dormitories, and recreational facilities.", new Date("2024-07-01"), new Date("2025-06-30"));
        ...
        const project8 = new Project(defaultUser, "Sports Stadium", ProjectCategory.URBAN, "Creating a new sports stadium that can host various sporting events and concerts, with a focus on sustainability.", new Date("2024-08-01"), new Date("2025-05-31"));
        ...
        const project9 = new Project(defaultUser, "Mixed-Use Development", ProjectCategory.MIXED_USE, "Designing a mixed-use development that combines residential, commercial, and recreational spaces in a vibrant urban setting.", new Date("2024-09-01"), new Date("2025-04-30"));
        ...
        const project10 = new Project(defaultUser, "Historic Building Renovation", ProjectCategory.HISTORIC, "Renovating a historic building to preserve its architectural heritage while adapting it for modern use.", new Date("2024-10-01"), new Date("2025-03-31"));
        ...
        const project11 = new Project(defaultUser, "Urban Farm", ProjectCategory.URBAN, "Creating an urban farm that promotes sustainable agriculture and provides fresh produce to the local community.", new Date("2024-11-01"), new Date("2025-02-28"));
        ...
        const project12 = new Project(defaultUser, "Cultural Center", ProjectCategory.CULTURAL, "Designing a cultural center that celebrates local art, music, and traditions while fostering community engagement.", new Date("2024-12-01"), new Date("2025-01-31"));
        ...
        const project13= new Project(defaultUser, "Green Roof Initiative", ProjectCategory.LANDSCAPE, "Implementing a green roof initiative to promote biodiversity and reduce urban heat island effects in the city.", new Date("2025-01-01"), new Date("2025-12-31"));
        ...
        const project14 = new Project(defaultUser, "Affordable Housing", ProjectCategory.RESIDENTIAL, "Designing affordable housing solutions to address the growing demand for housing in urban areas.", new Date("2025-02-01"), new Date("2025-11-30"));
        ...
        const project15 = new Project(defaultUser, "Public Library", ProjectCategory.CULTURAL, "Creating a new public library that serves as a community hub for learning, creativity, and social interaction.", new Date("2025-03-01"), new Date("2025-10-31"));
        ...
        const project16 = new Project(defaultUser, "Renewable Energy Plant", ProjectCategory.INFRASTRUCTURE, "Constructing a renewable energy plant that harnesses solar and wind power to provide clean energy to the city.", new Date("2025-04-01"), new Date("2025-09-30"));
        ...
        const project17 = new Project(defaultUser, "Public Transportation Hub", ProjectCategory.INFRASTRUCTURE, "Designing a new public transportation hub that integrates various modes of transportation and promotes sustainable mobility.", new Date("2025-05-01"), new Date("2025-08-31"));
        ...
        const project18 = new Project(defaultUser, "Art Gallery", ProjectCategory.CULTURAL, "Creating a new art gallery that showcases contemporary art and provides a platform for emerging artists.", new Date("2025-06-01"), new Date("2025-07-31"));
        ...
        const project19 = new Project(defaultUser, "Urban Renewal Project", ProjectCategory.URBAN, "Implementing an urban renewal project that revitalizes a neglected neighborhood and promotes economic development.", new Date("2025-06-30"), new Date("2025-07-01"));
        ...
        const project20 = new Project(defaultUser, "Sustainable Housing Development", ProjectCategory.RESIDENTIAL, "Designing a sustainable housing development that incorporates energy-efficient features and promotes eco-friendly living.", new Date("2025-05-31"), new Date("2025-08-01"));
