...
function GenerateProject() {
    const project: Project = {
        ...
        projectName: chooseRandomProjectName(),
        projectStatus: chooseRandomProjectStatus(),
        projectCategory: chooseRandomProjectCategory(),
        projectProgres: chooseRandomProjectProgress(),
        projectCurrentStage: chooseRandomProjectStage(),
        projectStartDate: chooseRandomProjectStartDate(),
        projectDueDate: chooseRandomProjectDueDate(),
        projectCreatedAt: new Date().toISOString(),
        projectUpdatedAt: new Date().toISOString(),
        projectWorkingHours: chooseRandomWorkingHours(),
        projectDescription: chooseRandomProjectDescription()
    }
    return project;
}
